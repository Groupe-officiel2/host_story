...
<head>
    ...
    <style>
        ...
        .vs-close-btn { position: absolute; top: 5px; right: 2px; background: none; border: none; color: var(--vs-text-muted); font-size: 2.5rem; cursor: pointer; transition: color 0.2s; }
        .vs-close-btn:hover { color: #c94a4a; }
            ...
            <div class="vs-modal-content">
                ...
                <div class="vs-profile-banner">
                    ...
                    <div class="vs-profile-info">
                        ...
                        <p class="vs-profile-created_at">Crée le  : {{ Auth::user()->created_at->format('d/m/Y') }}</p>
