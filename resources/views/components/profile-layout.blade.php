...
<head>
    ...
    <style>
        ...
        .vs-gear-btn:hover svg {
            transform: rotate(90deg);
            fill: var(--vs-text-parchment);
        }
        ...
        .vs-modal-overlay.active .vs-modal-content {
    ...
    @auth
        ...
        <div class="vs-modal-overlay" id="profileModal">
            ...
            <div class="vs-modal-content">
                ...
                <div class="vs-profile-banner">
                    <div class="vs-avatar">
                        <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path
                                d="M12 1c-1.1 0-2 .9-2 2H8v2h1.1c-.6 1.1-.9 2.5-.9 4H6v2h2.1c0 1.5.3 2.9.9 4H8v2h6v-2h1.1c.6-1.1.9-2.5.9-4h2.1v-2h-2.1c0-1.5-.3-2.9-.9-4H16V3h-4c0-1.1-.9-2-2-2z"
                                opacity="0.15" />
                        </svg>
                    </div>
                    <div class="vs-profile-info">
                        ...
                        <p class="vs-profile-created_at">Crée le : {{ Auth::user()->created_at->format('d/m/Y à H\hi') }}
                        </p>
                ...
                @if (session('success'))
                    <div
                        style="background: rgba(39, 105, 45, 0.2); border: 1px solid #27692d; color: #e2c9b0; padding: 10px; margin-bottom: 20px; text-align: center; font-style: italic;">
                        {{ session('success') }}
                    </div>
                @endif
                ...
                @if ($errors->any())
                    <div
                        style="background: rgba(153, 27, 27, 0.2); border: 1px solid #991b1b; color: #e2c9b0; padding: 10px; margin-bottom: 20px;">
                ...
                <div style="margin-top: 1rem; border-top: 2px dashed #5c4a3f; padding-top: 1.5rem;">
                    <h2 class="vs-title" style="font-size: 1.2rem; border-bottom: none; margin-bottom: 1rem;">Modifier votre
                        profil</h2>
                    ...
                    <form method="POST" action="{{ route('account.update') }}">
                        ...
                        <div class="vs-group">
                            ...
                            <input type="text" name="name" class="vs-input"
                                value="{{ old('name', Auth::user()->name) }}" required>
                        </div>

                        <div class="vs-group">
                            <label class="vs-label">Nouvelle adresse e-mail</label>
                            <input type="email" name="email" class="vs-input"
                                value="{{ old('email', Auth::user()->email) }}" required>
                        </div>

                        <div class="vs-group">
                            <label class="vs-label">Nouveau mot de passe</label>
                            <input type="password" name="password" class="vs-input"
                                placeholder="Laisser vide pour ne rien changer">
                        </div>

                        <button type="submit" class="vs-button-logout"
                            style="background: #4a5c3f; border-bottom-color: #2b3d20; margin-top: 0.5rem;">
